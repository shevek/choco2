...
\subsection{Options for variables:}
	\begin{itemize}
		\item \mylst{CPOptions.NO\_OPTION}, \texttt{""}, or \textit{empty argument}
		\item \label{vbound:vboundoptions}\hypertarget{vbound:vboundoptions}{}
		\mylst{CPOptions.V\_BOUND} or \texttt{"cp:bound"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_ENUM} or \texttt{"cp:enum"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_BTREE} or \texttt{"cp:btree"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_BLIST} or \texttt{"cp:blist"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_LINK} or \texttt{"cp:link"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_MAKESPAN} or \texttt{"cp:makespan"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_NO\_DECISION} or \texttt{"cp:no\_decision"}
		\begin{itemize}
		...
		\mylst{CPOptions.V\_OBJECTIVE} or \texttt{"cp:objective"}
		\begin{itemize}
...
\subsection{Options for expressions:}
	\begin{itemize}				
		...
		\mylst{CPOptions.E\_DECOMP} or \texttt{"cp:decomp"}
		\begin{itemize}
...
\subsection{Options and settings for constraints:}
	\begin{itemize}	
		...
		\mylst{CPOptions.C\_EXT\_AC3} or \texttt{"cp:ac3"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_EXT\_AC32} or \texttt{"cp:ac32"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_EXT\_AC322} or \texttt{"cp:ac322"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_EXT\_AC2001} or \texttt{"cp:ac2001"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_EXT\_AC2008} or \texttt{"cp:ac2008"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_EXT\_FC} or \texttt{"cp:fc"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_ALLDIFFERENT\_AC} or \texttt{"cp:ac"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_ALLDIFFERENT\_BC} or \texttt{"cp:bc"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_GCC\_BC} or \texttt{"cp:bc"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_INCREASING\_NVALUE\_ATLEAST} or \texttt{"cp:atleast"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_INCREASING\_NVALUE\_ATMOST} or \texttt{"cp:atmost"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_INCREASING\_NVALUE\_BOTH} or \texttt{"cp:both"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_NTH\_G} or \texttt{"cp:G"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_CLAUSES\_ENTAIL} or \texttt{"cp:entail"}
		\begin{itemize}
		...
		\mylst{CPOptions.C\_POST\_PONED} or \texttt{"cp:postponed"}
		\begin{itemize}
...
%% SettingType
		...
		\item \label{cdisjunctivedf:cdisjunctivedfoptions}\hypertarget{cdisjunctivedf:cdisjunctivedfoptions}{}				
		\mylst{SettingType.VILIM\_FILTERING} or \texttt{"cp:unary:df"}
		\begin{itemize}
				\item \textbf{goal} : use filtering algorithm proposed by Vilim. nested loop, each rule is applied until it reach it fixpoint.
				\item \textbf{scope} : 
					\begin{itemize}
...
\subsection{Options for solvers:}
	\begin{itemize}	
		...
		\mylst{CPOptions.S\_MULTIPLE\_READINGS} or \texttt{"cp:multiple\_readings"}
		\begin{itemize}
