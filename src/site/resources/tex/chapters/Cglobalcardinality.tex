...
\begin{itemize}
	...
	\begin{itemize}
		\item \emph{no option} :
		\item \texttt{CPOptions.C_GCC_AC} : for \cite{ReginAAAI96} implementation of arc consistency
		\item \texttt{CPOptions.C_GCC_BC} : for  \cite{QuimperCP03} implementation of bound consistency
	\end{itemize}
