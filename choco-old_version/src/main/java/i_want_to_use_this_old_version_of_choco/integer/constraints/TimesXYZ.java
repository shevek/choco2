...
public class TimesXYZ extends AbstractTernIntConstraint {
  ...
  protected int getXminIfNonZero() {
    if ((v2.getInf() >= 0) && (v1.getInf() >= 0)) return ruleA1(v0, v2, v1);
    else
    if ((v2.getSup() <= 0) && (v1.getSup() <= 0)) return ruleB1(v0, v2, v1);
    else
    if ((v2.getInf() >= 0) && (v1.getSup() <= 0)) return ruleC1(v0, v2, v1);
    else
    if ((v2.getSup() <= 0) && (v1.getInf() >= 0)) return ruleD1(v0, v2, v1);
    ...
    else throw new Error("None of the cases is active!");
  }

  protected int getXmaxIfNonZero() {
    if ((v2.getInf() >= 0) && (v1.getInf() >= 0)) return ruleA2(v0, v2, v1);
    else
    if ((v2.getSup() <= 0) && (v1.getSup() <= 0)) return ruleB2(v0, v2, v1);
    else
    if ((v2.getInf() >= 0) && (v1.getSup() <= 0)) return ruleC2(v0, v2, v1);
    else
    if ((v2.getSup() <= 0) && (v1.getInf() >= 0)) return ruleD2(v0, v2, v1);
  ...
  protected int getYminIfNonZero() {
    if ((v2.getInf() >= 0) && (v0.getInf() >= 0)) return ruleA1(v1, v2, v0);
    else
    if ((v2.getSup() <= 0) && (v0.getSup() <= 0)) return ruleB1(v1, v2, v0);
    else
    if ((v2.getInf() >= 0) && (v0.getSup() <= 0)) return ruleC1(v1, v2, v0);
    else
    if ((v2.getSup() <= 0) && (v0.getInf() >= 0)) return ruleD1(v1, v2, v0);
  ...
  protected int getYmaxIfNonZero() {
    if ((v2.getInf() >= 0) && (v0.getInf() >= 0)) return ruleA2(v1, v2, v0);
    else
    if ((v2.getSup() <= 0) && (v0.getSup() <= 0)) return ruleB2(v1, v2, v0);
    else
    if ((v2.getInf() >= 0) && (v0.getSup() <= 0)) return ruleC2(v1, v2, v0);
    else
    if ((v2.getSup() <= 0) && (v0.getInf() >= 0)) return ruleD2(v1, v2, v0);
  ...
  protected int getZmin() {
    if ((v0.getInf() >= 0) && (v1.getInf() >= 0)) return ruleA3(v2, v0, v1);
    else
    if ((v0.getSup() <= 0) && (v1.getSup() <= 0)) return ruleB3(v2, v0, v1);
    else
    if ((v0.getInf() >= 0) && (v1.getSup() <= 0)) return ruleC3(v2, v0, v1);
    else
    if ((v0.getSup() <= 0) && (v1.getInf() >= 0)) return ruleD3(v2, v0, v1);
  ...
  protected int getZmax() {
    if ((v0.getInf() >= 0) && (v1.getInf() >= 0)) return ruleA4(v2, v0, v1);
    else
    if ((v0.getSup() <= 0) && (v1.getSup() <= 0)) return ruleB4(v2, v0, v1);
    else
    if ((v0.getInf() >= 0) && (v1.getSup() <= 0)) return ruleC4(v2, v0, v1);
    else
    if ((v0.getSup() <= 0) && (v1.getInf() >= 0)) return ruleD4(v2, v0, v1);
