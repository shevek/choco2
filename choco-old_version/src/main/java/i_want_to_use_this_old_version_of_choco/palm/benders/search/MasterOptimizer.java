...
public class MasterOptimizer extends MasterGlobalSearchSolver {
  ...
  public MasterOptimizer(IntDomainVar obj, int nbSub, MasterSlavesRelation relation) {
    super(obj.getProblem(), nbSub, relation);
  }
  ...
  public MasterOptimizer(IntDomainVar obj, int nbSub, boolean maximize) {
    super(obj.getProblem(), nbSub);
    this.master = new SubOptimizer(obj, maximize, true);
    this.subproblems = new SubSearchSolver(problem, true);
  ...
  public void logMasterSolution() {
    if (logger.isLoggable(Level.FINE)) {
      ...
      IntDomainVar[] mvs = ((BendersProblem) problem).getMasterVariables();
