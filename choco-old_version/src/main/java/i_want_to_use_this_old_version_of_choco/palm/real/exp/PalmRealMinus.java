...
public class PalmRealMinus extends AbstractPalmRealBinTerm {
   ...
   */
  public void tighten() {
    PalmRealInterval res = PalmRealMath.sub((PalmProblem) this.getProblem(), exp1, exp2);
    inf.set(res.getInf());
    sup.set(res.getSup());
  ...
  public void project() throws ContradictionException {
    exp1.intersect(PalmRealMath.add((PalmProblem) this.getProblem(), this, exp2));
    exp2.intersect(PalmRealMath.sub((PalmProblem) this.getProblem(), exp1, this));
  }
}
