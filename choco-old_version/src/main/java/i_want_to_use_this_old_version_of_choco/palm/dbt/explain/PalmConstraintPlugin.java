...
public class PalmConstraintPlugin implements ExplainedConstraintPlugin {
  ...
  void addDependingConstraint(AbstractConstraint constraint) {
  ...
  void removeDependingConstraint(AbstractConstraint constraint) {
  ...
  public void removeDependance() {
    ...
    for (int i = b.nextSetBit(0); i >= 0; i = b.nextSetBit(i + 1)) {
      AbstractConstraint constraint = ((PalmProblem) this.touchedConstraint.getProblem()).getConstraintNb(i);
  ...
  public void informControllersOfDeactivation() {
    for (int i = 0; i < controllingConstraints.size(); i++) {
      ...
      ((PalmConstraint) controler.getConstraint()).takeIntoAccountStatusChange(controler.getIndex());
    }
  }
  ...
  private void deactivate() {
    ...
    for (int i = bitset.nextSetBit(0); i >= 0; i = bitset.nextSetBit(i + 1)) {
      ...
      AbstractConstraint constraint = (AbstractConstraint) ((PalmProblem) this.touchedConstraint.getProblem()).getConstraintNb(i);
      ...
      if (((PalmConstraintPlugin) constraint.getPlugIn()).isEphemeral()) {
        ((PalmProblem) this.touchedConstraint.getProblem()).remove(constraint);
      } else {
