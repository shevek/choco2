...
public class LeximinConstraint extends AbstractLargeIntConstraint {
    ...
    */
    ...
    private void generateVectors() {
        ...
        int maximumY = 0;
        for (int i = 0; i < n; i++) {
            this.sortedFloorx[i] = this.problem.getEnvironment().makeInt(super.vars[i].getInf());
            this.floorx[i] = this.problem.getEnvironment().makeInt(super.vars[i].getInf());
            ...
            this.sortedCeily[i] = this.problem.getEnvironment().makeInt(super.vars[n + i].getSup());
            this.ceily[i] = this.problem.getEnvironment().makeInt(super.vars[n + i].getSup());
    ...
    public void setPointersAndFlags() throws ContradictionException {
        ...
        if (this.alpha.get() == u + 1) {
            ...
            this.fail(); // For ensuring strict inequality
        } else {
