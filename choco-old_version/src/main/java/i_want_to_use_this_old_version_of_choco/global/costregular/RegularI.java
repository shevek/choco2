 ...
 * Time: 8:41:46 AM
 */
public class RegularI extends AbstractLargeIntConstraint
{
    ...
    public RegularI(IntDomainVar[] vars, Automaton auto)
    {
        ...
        outSave = new DLList[vars[0].getProblem().getNbIntVars()+2][];
    ...
    {
        return vars[0].getProblem().getEnvironment().getWorldIndex();
    }
