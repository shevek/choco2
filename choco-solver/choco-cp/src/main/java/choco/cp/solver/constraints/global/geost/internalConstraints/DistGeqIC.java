 ...
 */
public class DistGeqIC extends ForbiddenRegion {
    ...
    public DistGeqIC(Setup stp_, int q_, int D_, int s1_, int s2_, int o1_, int o2_) {
        ...
        if (q!=2) {System.out.println("DistGeqIC:Only norm 2 is supported for now."); System.exit(-1); }
    }
    ...
    public boolean insideForbidden(Point p) {
           //System.out.println("-- ENTERING segInsideForbidden");
        ...
        double norm=norm(m,q); //norm computes the q-norm

        //System.out.println("-- EXITING segInsideForbidden : "+m+" "+norm+"<"+D+":"+(norm<D));
    ...
    public int maximizeSizeOfFBox(boolean min, int d, int k, Region f) {
        ...
        //System.out.println("f:"+f+";m:"+m+";d:"+d+";D:"+D+";q_sum:"+q_sum+";term:"+term+";plus_inf:"+plus_infinity+";minus_inf:"+minus_infinity);
        //System.out.println("term:"+term+";o2_x_d_lb:"+o2_x_d_lb+";s2_t_d:"+s2_t_d+";s2_l_d:"+s2_l_d+";s1_t_d:"+s1_t_d);
