...
//            throw new IndexOutOfBoundsException("fromIndex < 0: " + fromIndex);
    ...
    /*public static void main(String[] args) throws Exception{
        ...
        StoredBitSet a = new StoredBitSet((EnvironmentTrailing) pb.getEnvironment(), 5);
        StoredBitSet b = new StoredBitSet((EnvironmentTrailing) pb.getEnvironment(), 5);
        StoredBitSet c = new StoredBitSet((EnvironmentTrailing) pb.getEnvironment(), 5);
        StoredBitSet d = (StoredBitSet) b.clone();
        a.set(0, 4, true);
        b.set(3, 5, true);
        c.set(0, 4, true);
