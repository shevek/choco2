...
public class ObservableStepSearchLoopWithRecomputation extends SearchLoopWithRecomputation implements IObservableStepSearchLoop {
    ...
    public ObservableStepSearchLoopWithRecomputation(AbstractGlobalSearchStrategy searchStrategy) {
