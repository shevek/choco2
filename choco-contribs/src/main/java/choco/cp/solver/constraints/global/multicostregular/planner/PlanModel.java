  ...
  bSup[i] = 32;    */
        ...
        /* for (int i = 4 ; i < nbAct+4 ; i++)
      {
        ...
        main = multiCostRegular(shifts,costs,auto,csts);
                //new ComponentConstraint(MutiCostRregularManager.class,new Object[]{costs,auto,csts}, shifts);
      ...
      /*  int[] bInf = new int[4];
        ...
        IntegerVariable[] count = makeIntVarArray("count",shifts.length,0,3,"cp:bound");
    ...
    private String letterFromVal(int val)
    {
        switch (val)
        {
